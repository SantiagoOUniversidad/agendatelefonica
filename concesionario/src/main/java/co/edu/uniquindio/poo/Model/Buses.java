...
public class Buses extends Vehiculo {
    ...
    public Buses(TipoCombustible tipoCombustible, TipoCaja tipoCaja, Estado estado, String marca, double modelo,
            double cambios, double velocidadMax, double cilindraje, double pasajeros, double numeroPuertas,
            double capacidadMaletero, Boolean aC, double airbags, Boolean camaraReversa, Boolean abs, double ejes,
            double salidas, String placa) {
