...
public class PickUp extends Vehiculo {
    ...
    public PickUp(TipoCombustible tipoCombustible, TipoCaja tipoCaja, Estado estado, String marca, double modelo,
            double cambios, double velocidadMax, double cilindraje, double pasajeros, double numeroPuertas,
            double capacidadMaletero, Boolean aC, double airbags, Boolean camaraReversa, Boolean abs,
            Boolean traccionCuatro,String placa) {
