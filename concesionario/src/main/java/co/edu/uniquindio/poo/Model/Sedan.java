...
public class Sedan extends Vehiculo {
    ...
    public Sedan(TipoCombustible tipoCombustible, TipoCaja tipoCaja, Estado estado, String marca, double modelo,
            ...
            Boolean sensoresColision, Boolean traficoCruzado, Boolean permanenciaCarril,String placa) {
    ...
    public String toString() {
        return "Sedan [pasajeros=" + pasajeros + ", numeroPuertas=" + numeroPuertas + ", capacidadMaletero="
                + capacidadMaletero + ", AC=" + AC + ", camaraReversa=" + camaraReversa + ", crucero=" + crucero
                + ", airbags=" + airbags + ", abs=" + abs + ", sensoresColision=" + sensoresColision
                + ", traficoCruzado=" + traficoCruzado + ", permanenciaCarril=" + permanenciaCarril + "]";
    }
